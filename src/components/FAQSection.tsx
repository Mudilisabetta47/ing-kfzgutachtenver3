...
const faqs = [
  ...
  { q: "Was kostet ein Kfz-Gutachten in Braunschweig?", a: "Die Kosten variieren je nach Schadenumfang und Fahrzeugtyp. Bei einem unverschuldeten Unfall trägt die gegnerische Versicherung die Gutachterkosten gemäß § 249 BGB." },
