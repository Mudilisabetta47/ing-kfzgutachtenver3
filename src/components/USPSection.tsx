    ...
    <div className="container-narrow">
      <ScrollReveal>
        <div className="text-center mb-16">
          <span className="text-primary font-bold text-sm uppercase tracking-[0.2em]">Ihre Vorteile</span>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {usps.map((u, i) => (
          <ScrollReveal key={u.title} delay={i * 0.1}>
            <motion.div
              className="bg-card p-8 border-b-4 border-primary hover:border-accent hover:shadow-xl transition-all duration-300 group"
              whileHover={{ y: -5 }}
              transition={{ duration: 0.3 }}
            >
              <div className="w-14 h-14 bg-primary flex items-center justify-center mb-5 group-hover:bg-accent transition-colors duration-300">
