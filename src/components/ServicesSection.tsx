...
const services = [
  { icon: Car, title: "PKW Gutachten", desc: "Unfallgutachten für Pkw – vom Kleinwagen bis zum Transporter.", img: imgUnfall, href: "/kfz-gutachten" },
  { icon: Truck, title: "LKW Gutachten", desc: "Fachgerechte Gutachten für Lkw und Nutzfahrzeuge aller Größen.", img: imgSchaden, href: "/lkw-gutachten" },
  { icon: Zap, title: "E-Auto & Hybrid", desc: "Begutachtung moderner Elektro- und Hybridfahrzeuge inkl. HV-System.", img: imgBewertung, href: "/gutachter-elektro-hybrid" },
  { icon: Bike, title: "Motorrad Gutachten", desc: "Gutachten für Motorräder, Roller und andere Krafträder.", img: imgOldtimer, href: "/motorrad-gutachten" },
  { icon: Award, title: "Oldtimer Gutachten", desc: "Bewertung & Dokumentation für klassische Fahrzeuge und Sammlerfahrzeuge.", img: imgLeasing, href: "/oldtimer-gutachten" },
  { icon: Wrench, title: "Bagatellschäden", desc: "Kostenvoranschläge für kleinere Schäden unter ca. 1.000 € netto.", img: imgBeweis, href: "/bagatellschaeden" },
];
