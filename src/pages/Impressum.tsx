      ...
      <div className="container-narrow max-w-3xl">
        <div className="prose prose-sm max-w-none text-muted-foreground space-y-6">
          <div>
            ...
            <p>ING KFZ Gutachten<br />Sachverständigenbüro für Kraftfahrzeuge<br />Braunschweig</p>
          </div>
          <div>
            <h3 className="font-heading text-xl text-foreground mb-2">Kontakt</h3>
            <p>Telefon: 0531 - 22 436 430<br />E-Mail: info@kfz-sachverstaendiger-braunschweig.de</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p>ING KFZ Gutachten<br />Braunschweig</p>
          </div>
          <div>
            <h3 className="font-heading text-xl text-foreground mb-2">Streitschlichtung</h3>
            <p className="text-sm leading-relaxed">Die Europäische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit: <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">https://ec.europa.eu/consumers/odr</a></p>
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed">Als Diensteanbieter sind wir gemäß § 7 Abs.1 TMG für eigene Inhalte auf diesen Seiten nach den allgemeinen Gesetzen verantwortlich. Nach §§ 8 bis 10 TMG sind wir als Diensteanbieter jedoch nicht verpflichtet, übermittelte oder gespeicherte fremde Informationen zu überwachen.</p>
          </div>
          <div>
            <h3 className="font-heading text-xl text-foreground mb-2">Urheberrecht</h3>
            <p className="text-sm leading-relaxed">Die durch die Seitenbetreiber erstellten Inhalte und Werke auf diesen Seiten unterliegen dem deutschen Urheberrecht.</p>
          </div>
        </div>
      </div>
    </section>
