    ...
    <section className="relative h-[45vh] min-h-[380px] flex items-end overflow-hidden">
      ...
      <div className="relative w-full max-w-6xl mx-auto px-4 pb-12">
        <nav className="flex items-center gap-2 text-primary-foreground/60 text-sm mb-4 font-body">
          ...
          <ChevronRight className="h-3 w-3" />
          <span className="text-accent font-medium">Unfall-Gutachten</span>
        </nav>
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          <h1 className="font-heading text-5xl md:text-7xl text-primary-foreground tracking-wide mb-2">Unfall-Gutachten</h1>
          <p className="text-primary-foreground/60 text-base max-w-xl font-body">Schadensgutachten im Haftpflichtschadenfall – für Ihre volle Entschädigung</p>
        </motion.div>
      </div>
    </section>
